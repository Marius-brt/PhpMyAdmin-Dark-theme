...
@font-face {
    font-family: 'IcoMoon';
    src: local('☺');
    src: url('./themes/pma-dark-theme/fonts/IcoMoon.eot');
    src: url('./themes/pma-dark-theme/fonts/IcoMoon.eot?#iefix') format('embedded-opentype'),
        url('./themes/pma-dark-theme/fonts/IcoMoon.svg#IcoMoon') format('svg'),
        url('./themes/pma-dark-theme/fonts/IcoMoon.woff') format('woff'),
        url('./themes/pma-dark-theme/fonts/IcoMoon.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/pma-dark-theme/fonts/opensans-regular-webfont.eot');
    src: url('./themes/pma-dark-theme/fonts/opensans-regular-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/pma-dark-theme/fonts/opensans-regular-webfont.woff') format('woff'),
        url('./themes/pma-dark-theme/fonts/opensans-regular-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/pma-dark-theme/fonts/opensans-light-webfont.eot');
    src: url('./themes/pma-dark-theme/fonts/opensans-light-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/pma-dark-theme/fonts/opensans-light-webfont.woff') format('woff'),
        url('./themes/pma-dark-theme/fonts/opensans-light-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/pma-dark-theme/fonts/opensans-bold-webfont.eot');
    src: url('./themes/pma-dark-theme/fonts/opensans-bold-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/pma-dark-theme/fonts/opensans-bold-webfont.woff') format('woff'),
        url('./themes/pma-dark-theme/fonts/opensans-bold-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: url('./themes/pma-dark-theme/fonts/opensans-extrabold-webfont.eot');
    src: url('./themes/pma-dark-theme/fonts/opensans-extrabold-webfont.eot?#iefix') format('embedded-opentype'),
        url('./themes/pma-dark-theme/fonts/opensans-extrabold-webfont.woff') format('woff'),
        url('./themes/pma-dark-theme/fonts/opensans-extrabold-webfont.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
body#loginform {
    margin: 0;
    background: url('./themes/pma-dark-theme/img/bg.png');
...
{
    background: url('./themes/pma-dark-theme/img/s_info.png') !important;
}
